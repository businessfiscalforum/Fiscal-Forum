  ...
  return (
    <>
      ...
      >
        ...
        <section className="pt-16 sm:py-10 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 relative overflow-hidden">
        ...
        <section className=" bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 relative">
