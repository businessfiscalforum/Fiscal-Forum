...
export async function GET(request: Request) {
  ...
  try {
    const reportItems = await db
      ...
      .where(eq(researchReportsTable.reportType, 'Pre-Market Research Report'))
    ...
    console.error('Error fetching Pre-Market Research Report:', error);
    return NextResponse.json(
      { error: 'Failed to fetch Pre-Market Research Report' },
