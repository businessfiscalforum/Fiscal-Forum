...
const STORES: Store[] = [
  ...
  },
  {
    ...
    img: "/fashion.jpg",
    pairs: [
      { brand: "Westside", stock: "Trent Ltd.", domain: "westside.com", stockDomain: "trentlimited.com" },
      { brand: "Zudio", stock: "Trent Ltd.", domain: "zudio.com", stockDomain: "trentlimited.com" },
      { brand: "Manyavar", stock: "Vedant Fashions Ltd.", domain: "manyavar.com", stockDomain: "vedantfashions.com" },
      { brand: "Pantaloons", stock: "Aditya Birla Fashion & Retail Ltd.", domain: "pantaloons.com", stockDomain: "abfrl.com" },
      { brand: "Louis Philippe", stock: "Aditya Birla Fashion & Retail Ltd.", domain: "louisphilippe.com", stockDomain: "abfrl.com" },
      { brand: "Allen Solly", stock: "Aditya Birla Fashion & Retail Ltd.", domain: "allensolly.com", stockDomain: "abfrl.com" },
      { brand: "Peter England", stock: "Aditya Birla Fashion & Retail Ltd.", domain: "peterengland.com", stockDomain: "abfrl.com" },
    ],
  },
  {
  ...
  },
  {
    ...
    img: "/coffee.jpg",
    pairs: [
      { brand: "Café Coffee Day", stock: "Coffee Day Enterprises", domain: "cafecoffeeday.com", stockDomain: "coffeeday.com" },
      { brand: "Britannia", stock: "Britannia Industries", domain: "britannia.co.in", stockDomain: "britannia.co.in" },
      { brand: "Tata Salt", stock: "Tata Consumer Products", domain: "tatasalt.com", stockDomain: "tataconsumer.com" },
      { brand: "Aashirvaad", stock: "ITC Ltd.", domain: "aashirvaad.com", stockDomain: "itcportal.com" },
      { brand: "Sunfeast", stock: "ITC Ltd.", domain: "sunfeast.com", stockDomain: "itcportal.com" },
      { brand: "Daawat", stock: "LT Foods", domain: "daawat.com", stockDomain: "ltgroup.in" },
      { brand: "Bikaji", stock: "Bikaji Foods International", domain: "bikaji.com", stockDomain: "bikaji.com" },
    ],
  },
  {
    ...
    img: "/electronics.jpg",
    pairs: [
      { brand: "Voltas", stock: "Voltas Ltd.", domain: "voltas.com", stockDomain: "voltas.com" },
      { brand: "Havells", stock: "Havells India Ltd.", domain: "havells.com", stockDomain: "havells.com" },
      { brand: "Lloyd", stock: "Havells India Ltd.", domain: "mylloyd.com", stockDomain: "havells.com" },
      { brand: "Crompton", stock: "Crompton Greaves Consumer Electricals Ltd.", domain: "crompton.co.in", stockDomain: "crompton.co.in" },
      { brand: "V-Guard", stock: "V-Guard Industries Ltd.", domain: "vguard.in", stockDomain: "vguard.in" },
      { brand: "Symphony", stock: "Symphony Ltd.", domain: "symphonylimited.com", stockDomain: "symphonylimited.com" },
      { brand: "Bajaj Electricals", stock: "Bajaj Electricals Ltd.", domain: "bajajelectricals.com", stockDomain: "bajajelectricals.com" },
    ],
  },
  {
    ...
    img: "/travel.jpg",
    pairs: [
      { brand: "IndiGo", stock: "InterGlobe Aviation Ltd.", domain: "goindigo.in", stockDomain: "goindigo.in" },
      { brand: "IRCTC", stock: "Indian Railway Catering & Tourism Corporation Ltd.", domain: "irctc.co.in", stockDomain: "irctc.co.in" },
      { brand: "EaseMyTrip", stock: "Easy Trip Planners Ltd.", domain: "easemytrip.com", stockDomain: "easemytrip.com" },
      { brand: "ixigo", stock: "Le Travenues Technology Ltd.", domain: "ixigo.com", stockDomain: "ixigo.com" },
      { brand: "Yatra", stock: "Yatra Online Ltd.", domain: "yatra.com", stockDomain: "yatra.com" },
      { brand: "SpiceJet", stock: "SpiceJet Ltd.", domain: "spicejet.com", stockDomain: "spicejet.com" },
      { brand: "Thomas Cook", stock: "Thomas Cook (India) Ltd.", domain: "thomascook.in", stockDomain: "thomascook.in" },
    ],
  },
];
