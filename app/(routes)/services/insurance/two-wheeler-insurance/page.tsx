...
export default function TwoWheelerInsuranceFormPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({
        text: "Your two-wheeler insurance request has been submitted successfully!",
        type: "success",
      });
        ...
        >
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
              Provide your details, vehicle & insurance information, upload documents, and select your preferred insurers.
            </p>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label htmlFor="policyExpiry" className="text-sm font-medium text-gray-700 mb-1 flex items-center">
                        <FaCalendarAlt className="mr-2 text-emerald-600" /> Policy Expiry Date (dd/mm/yyyy)
                      </label>
                      <input
                        type="text"
                        id="policyExpiry"
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="rcLink" className="text-sm font-medium text-gray-700 mb-1 flex items-center">
                      <FaFileUpload className="mr-2 text-emerald-600" /> Upload RC Copy (Registration Certificate)
                    </label>
                    <input
                      type="url"
                      id="rcLink"
                  ...
                  <div>
                    <label htmlFor="prevInsuranceLink" className="text-sm font-medium text-gray-700 mb-1 flex items-center">
                      <FaFileUpload className="mr-2 text-emerald-600" /> Upload Previous Insurance Copy
                    </label>
                    <input
                      type="url"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 bg-emerald-50 rounded-xl">
              ...
              <p className="text-gray-700">Provide vehicle & insurance info</p>
            </div>
            <div className="p-4 bg-emerald-50 rounded-xl">
              <div className="text-emerald-700 font-bold mb-2">Step 3</div>
              <p className="text-gray-700">Upload RC and insurance documents</p>
            </div>
            <div className="p-4 bg-emerald-50 rounded-xl">
