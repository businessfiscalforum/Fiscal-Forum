...
import { FaBullseye, FaCheck, FaArrowLeft, FaUser, FaFileInvoice, FaMobileAlt } from "react-icons/fa";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose max-w-none text-gray-700">
            <p className="mb-4">
              Futures and Options (F&O) are derivative instruments that derive their value 
              from an underlying asset. Futures are contracts to buy/sell at a predetermined 
              price on a future date. Options give the right (but not obligation) to 
              buy/sell at a specific price.
            </p>
            <h3 className="text-xl font-semibold text-teal-800 mt-6 mb-3">Benefits:</h3>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li>Hedging against market risk</li>
              <li>Leverage with lower capital requirement</li>
              <li>Profit potential in both rising and falling markets</li>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Complex strategies require expertise</li>
