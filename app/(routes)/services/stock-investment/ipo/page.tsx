...
import { FaRocket, FaCheck, FaArrowLeft, FaFileInvoice, FaMobileAlt, FaUser } from "react-icons/fa";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose max-w-none text-gray-700">
            <p className="mb-4">
              An Initial Public Offering (IPO) is when a private company offers its shares 
              to the public for the first time on a stock exchange. Investors can buy shares 
              during the IPO period at the offer price before regular trading begins.
            </p>
            <p className="mb-4">
              An IPO allows a company to raise capital from public investors. The company&apos;s 
              shares are listed on a stock exchange, enabling anyone to buy and sell them. 
              This process transforms a private company into a public one.
            </p>
            
            <h3 className="text-xl font-semibold text-green-800 mt-6 mb-3">Benefits:</h3>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li>Early investment in growing companies</li>
              <li>Potential for significant returns if company performs well</li>
              <li>Allocation at fixed price before market fluctuations</li>
              <li>Diversification into new sectors</li>
              <li>Participation in company growth story</li>
            </ul>
            
            <h3 className="text-xl font-semibold text-green-800 mt-6 mb-3">Risks:</h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>No historical trading data for evaluation</li>
              <li>High volatility after listing</li>
              <li>Lock-in periods may apply</li>
              <li>Market sentiment can affect pricing</li>
