      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 bg-gradient-to-r from-purple-600 via-violet-600 to-fuchsia-700 rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button onClick={() => router.push('/services/loan/personal-loan/call')} className="border-2 border-white/30 px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition-colors flex items-center justify-center gap-2">
