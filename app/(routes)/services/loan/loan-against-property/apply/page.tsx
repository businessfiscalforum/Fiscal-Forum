...
const LoanApplicationForm = () => {
  ...
  const renderPersonalDetails = () => (
    <div className="bg-white border border-blue-200 p-6 rounded-xl mb-6">
      <h3 className="text-blue-700 font-semibold mb-4 flex items-center">
        {/* <span className="bg-blue-500 text-white rounded-full w-7 h-7 flex items-center justify-center text-sm mr-3">
          1
        </span> */}
        APPLICANT DETAILS
      </h3>
  ...
  const renderAddressDetails = () => (
    <div className="bg-white border border-blue-200 p-6 rounded-xl mb-6">
      ...
      <div className="flex items-center mb-4">
        ...
        />
        <label htmlFor="permanentSame" className="text-sm text-gray-700">
  ...
  const renderTabContent = () => {
    const commonSections = [
      ...
      <React.Fragment key="employment">
        {renderEmploymentDetails()}
      </React.Fragment>,
      <React.Fragment key="obligations">
