      ...
      >
        ...
        <section className="space-y-6">
          ...
          {watch('employmentType') === 'Salaried' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-1">Company Address Line 1</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-1">Company Address Line 2</label>
                <textarea
          ...
          {watch('employmentType') === 'Salaried' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-1">Company City</label>
                <input
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-1">Company State</label>
                <input
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-1">Monthly Salary</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-1">Experience (Months)</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-1">Current Job Stability</label>
              <select
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-1">Property Address Line 2</label>
              <textarea
