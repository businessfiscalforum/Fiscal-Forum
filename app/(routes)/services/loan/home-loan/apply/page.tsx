...
const applicationSchema = z.object({
  ...
  propertyAddressLine1: z.string().min(1, 'Property address line 1 is required'),
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 py-30 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-emerald-800">Home Loan Application</h1>
        </div>
          ...
          <section className="border-b border-emerald-100 pb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.homeAddress1 && <p className="text-red-500 text-sm mt-1">{errors.homeAddress1.message}</p>}
              </div>
              <div>
                <textarea
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {watch('employmentType') === 'Self-Employed' && (
                <div>
                  ...
                  />
                  {errors.netMonthlySalary && <p className="text-red-500 text-sm mt-1">{errors.netMonthlySalary.message}</p>}
                </div>
              )}
            </div>
          </section>
            ...
            <div className="mt-4">
              <div>
                <textarea
                  ...
                  rows={2}
                  className={`w-full border ${errors.propertyAddressLine1 ? 'border-red-500' : 'border-gray-300'} rounded-md px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:outline-none transition`}
                />
                {errors.propertyAddressLine1 && <p className="text-red-500 text-sm mt-1">{errors.propertyAddressLine1.message}</p>}
              </div>
              <div className="mt-4">
                <textarea
                  ...
                  rows={2}
                  className={`w-full border ${errors.propertyAddressLine2 ? 'border-red-500' : 'border-gray-300'} rounded-md px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:outline-none transition`}
                />
              </div>
              <div className="mt-4">
                <input
          ...
          <section className="border-b border-emerald-100 pb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.noOfCurrentLoans && <p className="text-red-500 text-sm mt-1">{errors.noOfCurrentLoans.message}</p>}
              </div>
              <div>
                <select
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <input
                  ...
                  className={`w-full border ${errors.builderName ? 'border-red-500' : 'border-gray-300'} rounded-md px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:outline-none transition`}
                />
                {errors.builderName && <p className="text-red-500 text-sm mt-1">{errors.builderName.message}</p>}
              </div>
              <div>
                <select
                  {...register('residenceSince')}
                  className={`w-full border ${errors.residenceSince ? 'border-red-500' : 'border-gray-300'} rounded-md px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:outline-none transition`}
                >
                ...
                {errors.residenceSince && <p className="text-red-500 text-sm mt-1">{errors.residenceSince.message}</p>}
              </div>
              <div>
                <input
                  {...register('specialName')}
                  placeholder="Special Name"
                  className={`w-full border ${errors.specialName ? 'border-red-500' : 'border-gray-300'} rounded-md px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:outline-none transition`}
                />
              </div>
            </div>
          </section>
