...
export default function IndusIndBankPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append("accountType", "indusind");
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose max-w-none text-gray-700">
            <p className="mb-4">
              IndusInd Bank offers a premium savings account experience with innovative features designed for modern banking needs.
            </p>
            
            <h3 className="text-xl font-semibold text-emerald-800 mt-6 mb-3">Key Features:</h3>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li>Choose your phone number as your easy-to-remember account number</li>
              <li>Zero AMC charges on your digital card — save more every year</li>
              <li>Complete application support for a smooth, hassle-free banking experience</li>
              <li>Minimum initial deposit: ₹5,000 during account opening on the same day</li>
              <li>Withdrawals allowed 15 minutes after initial funding is completed</li>
