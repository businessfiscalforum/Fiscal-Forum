...
export default function FiBankPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append("accountType", "fi");
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose max-w-none text-gray-700">
            <p className="mb-4">
              FI Bank offers a revolutionary zero balance savings account with no minimum balance requirements, giving you complete financial freedom.
            </p>
            
            <h3 className="text-xl font-semibold text-emerald-800 mt-6 mb-3">Key Features:</h3>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li>Enjoy hassle-free banking with our zero balance account — no minimum balance, total freedom</li>
              <li>Zero balance savings account: keep your money flexible, with no balance requirements ever</li>
              <li>Open your zero balance account — simple, convenient, and no minimum balance to maintain</li>
              <li>Instant account opening with Aadhaar-based KYC</li>
              <li>24/7 mobile banking with advanced security features</li>
              <li>Free debit card with zero forex markup on international transactions</li>
            </ul>
