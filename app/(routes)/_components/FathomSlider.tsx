          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch px-4 md:px-8">
            ...
            >
              ...
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <div className="relative inline-block button-border-animate-container hover:-translate-y-0.5 transition-all duration-200">
                    {/* Animated Border Overlay */}
                    ...
                    <Link href="/reports">
                      <button className="px-6 py-2.5 bg-black !text-white font-extrabold text-xs uppercase tracking-wider rounded-xl shadow-sm hover:bg-zinc-900 transition-all cursor-pointer relative z-10 block text-center">
                        CLICK HERE
                      </button>
                    </Link>
                  </div>
