...
const ResearchReportsSection = () => {
  ...
  // Initialize chart with green/emerald colors
  useEffect(() => {
    if (chartRef.current) {
  ...
  return (
    <section className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto my-20 p-6 md:p-10 bg-white border border-emerald-200 shadow-lg rounded-2xl">
      {/* Main Content */}
