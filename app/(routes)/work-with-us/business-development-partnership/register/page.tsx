...
const Page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validate()) {
      ...
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/bdp`, {
          method: "POST",
          headers: {
        ...
        // alert("Form submitted successfully!"); // Removed alert
          ...
          {isSubmitted ? (
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full border border-emerald-200">
              <div className="text-center mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Become a Business Development Partner</h2>
              </div>
