  ...
  const sections = [
    {
      ...
      content: (
        <p className="m-0">
          This Privacy Policy describes how <strong className="font-bold text-[#171512]">8696060387</strong> and its affiliates (collectively &quot;<strong className="font-bold text-[#171512]">8696060387</strong>, we, our, us&quot;) collect, use, share, protect or otherwise process your information/ personal data through our website <strong className="font-bold text-[#171512]">https://www.fiscalforum.in</strong> (hereinafter referred to as <strong className="font-bold text-[#171512]">Platform</strong>). Please note that you may be able to browse certain sections of the Platform without registering with us. We do not offer any product/service under this Platform outside India and your personal data will primarily be stored and processed in India. By visiting this Platform, providing your information or availing any product/service offered on the Platform, you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use and the applicable service/product terms and conditions, and agree to be governed by the laws of India including but not limited to the laws applicable to data protection and privacy. If you do not agree please do not use or access our Platform.
        </p>
      ),
    },
    {
    ...
    {
      id: "data-deletion-and-retention",
    ...
    >
      ...
      <div className="max-w-[850px] mx-auto px-6">
        <section className="py-10 space-y-8 text-[15px] sm:text-[15.5px] leading-[1.75] text-[#2C2825]">
          {sections.map((sec) => (
            <div key={sec.id} className="py-4 border-b border-[#D9D0BC]/60">
              <h2 className="font-[family-name:var(--font-source-serif)] font-bold text-[20px] sm:text-[22px] text-[#171512] mb-3">
                {sec.title}
              </h2>
              {sec.content}
            </div>
