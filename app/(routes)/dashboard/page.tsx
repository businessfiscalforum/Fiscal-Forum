      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <header className="border-b-2 border-black pb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-100 border-2 border-black text-black font-bold rounded-xl shadow-[3px_3px_0px_#000]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            return (
              <div
                key={idx}
                className="bg-white border-2 border-black p-6 rounded-2xl shadow-[4px_4px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#000] transition-all"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="bg-white border-2 border-black rounded-3xl p-6 shadow-[4px_4px_0px_#000]">
              ...
              <div className="space-y-3">
                {earningsHistory.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center justify-between p-3.5 border border-black/10 hover:border-black rounded-xl bg-gray-50 hover:bg-white hover:shadow-[2px_2px_0px_#000] transition-all"
                  >
                    <div>
