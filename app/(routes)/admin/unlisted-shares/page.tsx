...
import { dematTransferRequests, unlistedShares } from "../../../../config/schema";

export default async function QuoteRequestsPage() {
  const data = await db
    .select()
    .from(unlistedShares)
    .orderBy(unlistedShares.createdAt);
  ...
  return (
    <div className="py-20">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Unlisted Shares</h1>
      <p className="text-gray-600 mb-8">
        Total: {data.length} share(s)
      </p>
