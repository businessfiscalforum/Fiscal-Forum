...
export default async function QuoteRequestsPage() {
  const data = await db
    .select()
    .from(savingsApplications)
    .orderBy(savingsApplications.createdAt)
  ...
  return (
    <div className="py-20">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Savings Account Application</h1>
      <p className="text-gray-600 mb-8">
        Total: {data.length} request(s)
      </p>
