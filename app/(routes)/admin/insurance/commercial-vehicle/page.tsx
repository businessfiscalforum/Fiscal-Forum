...
import { commercialVehicleInsuranceRequests } from "../../../../../config/schema";

export default async function QuoteRequestsPage() {
  const data = await db
    .select()
    .from(commercialVehicleInsuranceRequests)
    .orderBy(commercialVehicleInsuranceRequests.createdAt);
  ...
  return (
    <div className="py-20">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Commercial Vehicle Insurances</h1>
      <p className="text-gray-600 mb-8">
        Total: {data.length} insurance(s)
      </p>
