...
import { healthInsuranceRequests } from "../../../../../config/schema";

export default async function QuoteRequestsPage() {
  const data = await db
    .select()
    .from(healthInsuranceRequests)
    .orderBy(healthInsuranceRequests.createdAt);
  ...
  return (
    <div className="py-20">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Health Insurances</h1>
