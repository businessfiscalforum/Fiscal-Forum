...
import { carInsuranceRequests } from "../../../../../config/schema";

export default async function QuoteRequestsPage() {
  const data = await db
    .select()
    .from(carInsuranceRequests)
    .orderBy(carInsuranceRequests.createdAt);
  ...
  return (
    <div className="py-20">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Car Insurances</h1>
