...
export default async function QuoteRequestsPage() {
  const data = await db
    .select()
    .from(dematTransferRequests)
    .orderBy(dematTransferRequests.createdAt);
  ...
  return (
    <div className="py-20">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Demat Transfer Requests</h1>
      <p className="text-gray-600 mb-8">
        Total: {data.length} requests(s)
      </p>
