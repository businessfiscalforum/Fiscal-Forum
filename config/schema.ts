...
export const customReportsTable = pgTable('custom_reports', {
  ...
  occupation: varchar('occupation', { length: 255 }),
  investmentPreference: varchar('investment_preference', { length: 100 }),
  annualIncome: varchar('annual_income', { length: 100 }),
  dependents: varchar('dependents', { length: 50 }),
  maritalStatus: varchar('marital_status', { length: 50 }),
  existingInsurance: text('existing_insurance'),
  insuranceCovers: text('insurance_covers'),
  loansLiabilities: text('loans_liabilities'),
  monthlySpending: varchar('monthly_spending', { length: 100 }),
  spendingCategories: text('spending_categories'),
  flyFrequency: varchar('fly_frequency', { length: 100 }),
  travelType: varchar('travel_type', { length: 100 }),
  loungeImportance: varchar('lounge_importance', { length: 10 }),
  feeComfort: varchar('fee_comfort', { length: 255 }),
  loanPurpose: varchar('loan_purpose', { length: 255 }),
  loanEmployment: varchar('loan_employment', { length: 255 }),
  loanMonthlyIncome: varchar('loan_monthly_income', { length: 100 }),
  loanIncomeStability: varchar('loan_income_stability', { length: 100 }),
  loanAmount: varchar('loan_amount', { length: 100 }),
  loanHasCollateral: varchar('loan_has_collateral', { length: 50 }),
  loanCollateralType: varchar('loan_collateral_type', { length: 100 }),
...
export type InsertCustomReport = typeof customReportsTable.$inferInsert;
export type SelectCustomReport = typeof customReportsTable.$inferSelect;
